...
Server-side sessions help the server keep track of the client authentication information 
such as whether they're logged in and for how long.

- [x] What does bcrypt do to help us store passwords in a secure manner.

bcrypt allows us to obscure passwords from attackers by hashing our user's passwords using a cryptographic
algorithm. 
